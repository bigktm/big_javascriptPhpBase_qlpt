...
<body onload="initialize(<?php if(isset($_REQUEST['tdk'])){echo $_REQUEST['tdk'];} else{echo "16.059459";}?>,<?php if(isset($_REQUEST['tdv'])){echo $_REQUEST['tdv'];} else{echo "108.216799";}?>)"> 
	<div id="web">
		<div id="banner">
